  ...
  return (
    <section id='price' className="bg-white py-16 px-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-orange-300">
                <th className="p-3 pr-10 text-xl text-slate-900">Type</th>
                <th className="p-3 pr-10 text-xl text-slate-900">Carpet Area</th>
                <th className="p-3 pr-10 text-xl text-slate-900">Price</th>
                <th className="p-3"></th>
              </tr>
            </thead>
            <tbody>
              {priceData.map((item, index) => (
                ...
                >
                  <td className="p-3 pr-10 text-lg font-medium text-slate-700">{item.type}</td>
                  <td className="p-3 pr-10 text-lg text-slate-600">{item.area}</td>
                  <td className="p-3 pr-10 text-lg font-bold text-slate-900">{item.price}</td>
                  <td className="p-3 text-right">
                    <button className="bg-[#A67C48] text-white px-6 py-2 rounded-md text-sm font-medium hover:bg-[#8e693c] transition-colors shadow-sm whitespace-nowrap">
                      Price Breakup
                    </button>
                  </td>
                </tr>
        ...
        {/* Right: Detail Sheet Preview (Reduced Width) */}
        <div className="w-full lg:w-[320px] flex-shrink-0 flex flex-col items-center">
          <div className="border border-orange-300 p-2 bg-white shadow-sm w-full">
            {/* Smaller Simulated Document Preview */}
          ...
          {/* Main Action Button */}
          <button className="mt-6 w-full bg-[#C68A55] text-white px-6 py-3 rounded-full text-md font-semibold shadow-md hover:bg-[#b07848] transition-all transform hover:scale-105">
